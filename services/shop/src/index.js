...
import { DSP_HOST, DSP_A_HOST, DSP_B_HOST, DSP_X_HOST, DSP_Y_HOST, EXTERNAL_PORT, PORT, SHOP_DETAIL, SHOP_HOST, SSP_HOST, } from './env.js';
...
app.get('/items/:id', async (req, res) => {
    ...
    let DSP_A_TAG_URL = new URL(`https://${DSP_A_HOST}:${EXTERNAL_PORT}/dsp-tag.js`);
    let DSP_B_TAG_URL = new URL(`https://${DSP_B_HOST}:${EXTERNAL_PORT}/dsp-tag.js`);
    let DSP_X_TAG_URL;
    let DSP_Y_TAG_URL;
    if (auctionType === 'ba') {
        DSP_A_TAG_URL = new URL(`https://${DSP_A_HOST}:${EXTERNAL_PORT}/uc-ba/js/dsp-tag.js`);
        DSP_B_TAG_URL = new URL(`https://${DSP_B_HOST}:${EXTERNAL_PORT}/uc-ba/js/dsp-tag.js`);
        DSP_X_TAG_URL = new URL(`https://${DSP_X_HOST}:${EXTERNAL_PORT}/uc-ba/js/dsp-tag.js`);
        DSP_Y_TAG_URL = new URL(`https://${DSP_Y_HOST}:${EXTERNAL_PORT}/uc-ba/js/dsp-tag.js`);
    }
    res.render('item', {
        item,
        DSP_TAG_URL,
