  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: 'disclaimer',
        content:
          '<b>Some Privacy Sandbox technologies are being phased out</b>. For more details, see the <a target="_blank" rel="noopener noreferrer" href="https://privacysandbox.com/news/update-on-plans-for-privacy-sandbox-technologies/">Update on Plans for Privacy Sandbox Technologies</a> and the <a target="_blank" rel="noopener noreferrer" href="https://privacysandbox.google.com/overview/status">Privacy Sandbox feature status</a>. This demo site and its repository are scheduled to be archived.',
