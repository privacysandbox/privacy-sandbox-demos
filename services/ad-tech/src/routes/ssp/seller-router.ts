...
/**
 * This is the main SSP router and is responsible for handling a variety of
 * requests made at the top-level path: /ssp. This includes retrieving iframes
 * that deliver ads, auction configurations, and the wrapped VAST XML for video
 * ads.
 * 
 * Path: /ssp/
 */
...
SellerRouter.get(
  ...
  async (req: Request, res: Response) => {
    ...
    const auctionConfig = AuctionConfigHelper.constructAuctionConfig({
